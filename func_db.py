...
class DatabaseInterface:
    ...
    def add_user(self, id_user, username, userlogin, is_active):
        try:
            ...
            if int(n[0]) > 0:
                ...
                d = int(time.time())
                self.cur.execute("INSERT INTO user (id_user, username, userlogin, sub_time, is_active) VALUES (?, ?, ?, ?, ?)", (id_user, username, userlogin, d, is_active))
                self.conn.commit()
